...
const Entertainment = () => {
    ...
    return (
      <Container>
        <Head>
            <meta charset="utf-8" />
            <title>Somos SFM - Entretenimiento </title>
            ...
            {/*Open Graph / Facebook*/}
            <meta property="og:title" content="Somos SFM - Entretenimiento"/>
            ...
            {/* Twitter */}
            <meta property="twitter:title" content="Somos SFM - Entretenimiento"/>
          ...
          <div className="inicio">
            <div className="sub-inicio">
                <div className="sub-cuerpo mtop">
                  { loading ? <Processing processText={"Cargando..."}/> : <News data = {data} tipo="Entretenimiento"/> }
                </div>
            </div>
            <AdsComputadora />
          </div>
