...
const PrivacyPolicies = () => {
    return (
        <Container>
            <Head>
                <meta charset="utf-8" />
                <title>News - Privacy Policies </title>
                ...
                <div className="sub-inicio">
                    <div className="sub-cuerpo">
                        <div className="politicaDePrivacidad">
                            ...
                            <p>This page is used to inform website visitors regarding our policies with the collection, use, and disclosure of Personal Information if anyone decided to use our Service, the news website.</p>
                            ...
                            <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at news.cristiancastroastacio.com, unless otherwise defined in this Privacy Policy.</p>
