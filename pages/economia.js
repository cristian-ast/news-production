...
const Economy = () => {
    ...
    return (
      <Container>
        <Head>
            <meta charset="utf-8" />
            <title>Somos SFM - Economia </title>
            ...
            {/*Open Graph / Facebook*/}
            <meta property="og:title" content="Somos SFM - Economia"/>
            ...
            {/* Twitter */}
            <meta property="twitter:title" content="Somos SFM - Economia"/>
          ...
          <div className="inicio">
            <div className="sub-inicio">
                <div className="sub-cuerpo mtop">
                  { loading ? <Processing processText={"Loading..."}/> : <News data = {data} tipo="Economy"/> }
                </div>
            </div>
          </div>
      </Container> 
